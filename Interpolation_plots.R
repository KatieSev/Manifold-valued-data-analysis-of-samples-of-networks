...
rownames(int_euc_0pt5) <- words
colnames(int_euc_0pt5) <- words
rownames(int_euc_6) <- words
colnames(int_euc_6) <- words
...
rownames(int_sqrt_0pt5) <- words
colnames(int_sqrt_0pt5) <- words
rownames(int_sqrt_6) <- words
colnames(int_sqrt_6) <- words
...
rownames(int_proc_0pt5) <- words
colnames(int_proc_0pt5) <- words
rownames(int_proc_6) <- words
colnames(int_proc_6) <- words
