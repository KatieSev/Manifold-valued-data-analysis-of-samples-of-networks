...
rownames(int_euc_0pt5) <- words[1:m]
colnames(int_euc_0pt5) <- words[1:m]
rownames(int_euc_6) <- words[1:m]
colnames(int_euc_6) <- words[1:m]
rownames(int_euc_min5) <- words[1:m]
colnames(int_euc_min5) <- words[1:m]
...
dickens_sqrtmean <- proj_sparse( Mean_GL(List_L[1:16], euc=FALSE, sqrt=TRUE, proc=FALSE) )
austen_sqrtmean  <- proj_sparse( Mean_GL(List_L[17:23], euc=FALSE, sqrt=TRUE, proc=FALSE) )
...
rownames(int_sqrt_0pt5) <- words[1:m]
colnames(int_sqrt_0pt5) <- words[1:m]
rownames(int_sqrt_6) <- words[1:m]
colnames(int_sqrt_6) <- words[1:m]
rownames(int_sqrt_min5) <- words[1:m]
colnames(int_sqrt_min5) <- words[1:m]
...
####____________________________________________________________________
#procrustes
dickens_procmean <- proj_sparse( Mean_GL(List_L[1:16], euc=FALSE, sqrt=FALSE, proc=TRUE) )
austen_procmean  <- proj_sparse( Mean_GL(List_L[17:23], euc=FALSE, sqrt=FALSE, proc=TRUE) )
...
rownames(int_proc_0pt5) <- words[1:m]
colnames(int_proc_0pt5) <- words[1:m]
rownames(int_proc_6) <- words[1:m]
colnames(int_proc_6) <- words[1:m]
rownames(int_proc_min5) <- words[1:m]
colnames(int_proc_min5) <- words[1:m]
